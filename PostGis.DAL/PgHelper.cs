...
namespace PostGis.DAL
{
    ...
    public static class PgHelper
    {
        ...
        public static int ExecuteNonQuery(string connectionString, string spName, params object[] parameterValues)
        {
            ...
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
                ...
                NpgsqlParameter[] commandParameters = PgHelperParameterCache.GetSpParameterSet(connectionString, spName);
        ...
        public static int ExecuteNonQuery(NpgsqlConnection connection, string spName, params object[] parameterValues)
        {
            ...
            {
                // 从缓存中加载存储过程参数 
                NpgsqlParameter[] commandParameters = PgHelperParameterCache.GetSpParameterSet(connection, spName);
        ...
        /// <summary> 
        /// [私有方法][内部调用]执行指定数据库连接对象/事务的命令,映射数据表并填充数据集,DataSet/TableNames/NpgsqlParameters. 
        /// </summary> 
        /// <remarks> 
        /// 示例:  
    ...
    public static class PgHelperParameterCache
    {
        ...
        /// <summary> 
        /// 探索运行时的存储过程,返回NpgsqlParameter参数数组. 
